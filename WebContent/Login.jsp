...
<title>Memorama the Aline´s</title>
...
<section class="contenedor">
	<div class="styleDiv">
		<h1>Iniciar Sesion</h1>
			...
			<p align="center"><input type="text" name="usuario" id="usuario" placeholder="Usuario" /> </p> 
			<p align="center"><input type="password" name="password" id="password" placeholder="Contrasenia" /> </p>
